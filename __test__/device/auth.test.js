...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Vanessa59',
      password: 'n2EAsYwt7OPiJbn',
      email: 'Sonny.Hettinger21@hotmail.com',
      name: 'Brittany Klein',
      userType: 454,
      mobileNo: '1-237-477-9016',
      resetPasswordLink: {},
      loginRetryLimit: 880,
      loginReactiveTime: '2022-08-28T16:31:04.370Z',
      id: '623d9700b9f454b34ecdc9ee'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Mose.Schiller',
        'password':'MrpqIYn7RBgLS5n',
        'email':'Narciso_Parisian@gmail.com',
        'name':'Bruce Von',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'1-381-420-5395 x60341',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Narciso_Parisian@gmail.com', });
